...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{ url('/home') }}"><b>Ebulan</b>Blog</a>
        </div><!-- /.login-logo -->
    ...
    <form action="{{ url('/login') }}" method="post">
        ...
        <div class="form-group has-feedback">
            <input type="email" class="form-control" placeholder="Имейл хаяг" name="email"/>
    ...
    <a href="{{ url('/password/reset') }}">Нууц үгээ мартсан уу</a><br>
